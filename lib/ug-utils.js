...
export function computeLayoutMediaText(data) {
    ...
    let { textColBg = '', headingColor = '' } = colorClasses[mediaBgColor] || {};
    ...
    function getMediaClasses(region, mediaSize, textColBg, mediaDescription, mediaButtons) {
        ...
        const classes = {
            Primary: {
                withDescription: {
                    small: { ...commonClasses, mediaCol: "md:w-1/3", textCol: "md:w-2/3", wrapperCol: "md:w-1/2 flex flex-row mt-4" },
                    medium: { ...commonClasses, mediaCol: "md:w-1/2", textCol: "md:w-1/2", wrapperCol: "md:w-1/2 flex flex-row mt-4" },
                    large: { mediaCol: "w-full", textCol: "w-full", textColHeight: "h-full", wrapperCol: "md:w-1/2 mb-4 border-0 card" },
                    default: { mediaCol: "w-full", textCol: "w-full", textColHeight: "h-full", wrapperCol: "sm:w-auto mb-3 border-0 card" },
                },
                withoutDescription: {
                ...
                video: {
                    ...
                    medium: { wrapperCol: "md:w-1/2 border-0 card mb-4" },
...
export function buttonStyle(styleOfButton) {
  ...
  return styles[styleOfButton] || 'btn-primary';
}