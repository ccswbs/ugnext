...
export function computeLayoutMediaText(data) {
    ...
    function getMediaClasses(region, mediaSize, textColBg, mediaDescription, mediaButtons) {
        ...
        const classes = {
            Primary: {
                withDescription: {
                    small: { ...commonClasses, mediaCol: "md:w-1/3", textCol: "md:w-2/3", wrapperCol: "md:w-1/2 mt-4" },
                    medium: { ...commonClasses, mediaCol: "md:w-1/2", textCol: "md:w-1/2", wrapperCol: "md:w-1/2 mt-4" },
