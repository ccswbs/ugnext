...
const Select = ({ onChange, children, multiple = false, placeholder = 'Select a value...' }) => {
	...
	const optionsContainerClasses = twJoin(
		'absolute z-10 w-full rounded-b-md border border-t-0 border-gray-300 bg-white shadow-md group-focus-within:border-blue group-focus-within:outline-none ui-open:border-blue',
	);
