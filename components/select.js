...
const Select = ({ onChange, children, multiple = false, placeholder = 'Select a value...' }) => {
	...
	const buttonClasses = twJoin(
		'flex w-full items-center justify-between rounded-md border border-gray-300 px-4 py-2 shadow-sm group-focus-within:border-blue group-focus-within:outline-none ui-open:rounded-b-none',
	);
