  ...
  return (
    <Field className="flex flex-col gap-0.5">
      ...
      >
        ...
        <OptionsTag
          transition
          className="z-10 max-h-[20rem] w-full overflow-auto rounded-b-md border border-t-0 border-gray-300 bg-white shadow-md group-focus-within:border-blue group-focus-within:outline-hidden ui-open:border-blue md:absolute transition duration-300 ease-out data-closed:opacity-0"
        >
