...
export const Layout = ({ children, className, menu, footerLinks, title = '', description = '', image = null }) => {
	...
	return (
		<>
			...
			{!isFallback && (
				<a className="sr-only focus:not-sr-only fixed top-0 left-0 z-[1000] !w-fit bg-yellow underline px-0 focus:px-2 transition-[padding]" href="#content">Skip to content</a>
			)}
