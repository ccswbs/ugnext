...
export const ProfileContact = ({ data }: { data: ProfileCardFragment }) => {
  ...
  return (
    <Contact key={profileInfo.id} className="@xl:w-[475px] @xl:inline-block @xl:me-5 mb-5">
      <div className="@xl:grid @xl:grid-cols-[128px_1fr] @xl:gap-4">
        ...
        {profileInfo.profilePicture && shouldShowProfilePicture && (
          <div className="@xl:w-32 -mx-4 -mt-4 @xl:m-0">
            <Image
        ...
        <div>
        {profileInfo.title && (
          <ContactName className="@lg:mt-0">
            {profileInfo.title}
          </ContactName>
        )}
      
        {profileInfo.profileJobTitle && (
          <ContactTitle className="block">
            {profileInfo.profileJobTitle}
          </ContactTitle>
        )}
