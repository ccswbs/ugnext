...
export const SubNavigation = ({ links, label }) => {
  return (
    <div className='flex flex-col'>
      <span className='mb-3 lg:self-center'>{label}</span>
...
export const ButtonNavigation = ({ fullWidth = true, links, label }) => (
  <div className='mb-10'>
    ...
    <nav>
      <ul className="flex flex-col lg:flex-row gap-4 lg:gap-10 content-end">
        <li className="flex lg:self-end">
          <Button color="red" outlined className="lg:h-20">Program Home</Button>
        </li>
        ...
        <li>
          <SubNavigation
            label="Collaborative Specializations"
            links={[
