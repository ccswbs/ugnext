...
export const Card = ({ href, image, title, footer, className, centered, children }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={twJoin(
          "flex flex-1 flex-col gap-2 bg-uog-grey-light-bg p-5",
          href && "transition-colors group-hover:bg-uog-yellow"
        )}
      >
        {/* Card Title */}
      ...
      {footer && (
        <div
          className={twJoin(
            "flex gap-2 bg-uog-grey-light px-5 py-2 transition-colors",
