...
import RequirementsForm from "@/components/client/programs/undergraduate/requirements-form";
  ...
  return (
    <Layout>
      ...
      <LayoutContent>
        ...
        >
          <RequirementsForm studentTypes={studentTypes} locations={locations} programs={programs} />
